...
$conf['site']['baseUrl'] = 'http://localhost/vendor/www';
...
$conf['path']['installRoot'] = '/opt/lampp/htdocs/vendor';
$conf['path']['webRoot'] = '/opt/lampp/htdocs/vendor/www';
$conf['cookie']['path'] = '/';
$conf['cookie']['domain'] = '';
